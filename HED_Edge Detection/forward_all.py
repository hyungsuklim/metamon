...
parser.add_argument('--output', type=str, default='sigmoid_dsn1') # output field
...
test_dir = '../StarGAN/data/CelebA_nocrop/images/' # test images directory
save_dir = join('data/edge-results3/', splitext(split(args.model)[1])[0]) # directory to save results
if args.ms:
